  ...
  return (
    <div className="space-y-6 page-enter">
      <Breadcrumb
        items={[
          { label: 'Admin Panel' },
          { label: isRootAdmin ? 'Manage Users' : 'User Provisioning' },
        ]}
      />
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          Create end-user accounts and approve pending registrations.
        </p>
      </div>
      ...
      <Widget
        title="Create User"
        subtitle="Invited users receive a verification OTP email and are pre-approved."
      >
      ...
      <Widget
        ...
        subtitle="Self-registered TYPE2 accounts awaiting approval."
        footer={
          <Button
            variant="ghost"
            size="sm"
